...
public class PlayerMenu {
    ...
    private void handleAddPlayer() {
        ...
        AddPlayerResult result = manager.addPlayer(name, score);

        switch (result) {
            case SUCCESS -> System.out.println("Player added.");
            case DUPLICATE_NAME ->  System.out.println("Player with this name already exists.");
            case INVALID_NAME ->   System.out.println("Player name cannot be blank.");
        }
    }
    ...
    private void handleShowLowestPlayer() {
        ...
        System.out.println(lowestPlayer);
    }
