...
public class Day5Practice1 {
    public static void main(String[] args) {
        ...
        players.add(new Player("Alex", 80));
        players.add(new Player("Bob", 100));
        players.add(new Player("John", 70));
        players.add(new Player("Mike", 90));

        printPlayers(players);

        System.out.println();
        printSearchResult(players, "bob");

        System.out.println();
        printSearchResult(players, "Kate");

        System.out.println();
        updatePlayerScore(players, "Bob", 120);

        System.out.println();
        updatePlayerScore(players, "Kate", 90);

        System.out.println();
        removePlayer(players, "John");

        System.out.println();
        removePlayer(players, "Kate");

        System.out.println();
        addPlayer(players, "Kate", 75);
